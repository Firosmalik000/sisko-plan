 ...
 */
#[Fillable(['store_id', 'creation_token', 'category_id', 'base_unit_id', 'large_unit_id', 'variant_mode', 'quantity_mode', 'tracking_mode', 'name', 'description', 'photo_path', 'is_active'])]
