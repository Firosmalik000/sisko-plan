 ...
 */
#[Fillable(['store_id', 'sale_id', 'product_id', 'product_unit_id', 'product_name', 'sku', 'barcode', 'unit_name', 'unit_symbol', 'quantity', 'conversion_factor', 'base_quantity', 'unit_price', 'gross_subtotal', 'item_discount_amount', 'allocated_transaction_discount', 'net_total', 'unit_cost_snapshot', 'cogs_amount', 'gross_profit'])]
