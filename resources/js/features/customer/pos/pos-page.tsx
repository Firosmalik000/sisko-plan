...
import type { ScannerApplyResult, ScannerProductCandidate, ScannerSelection } from '@/features/product-scanner/types';
                            ...
                            >
                                ...
                                <div className="mt-5 space-y-3 border-t border-border pt-5">
                                    ...
                                    <button
                                        ...
                                        className="h-14 w-full rounded-xl bg-[var(--app-primary)] text-base font-black text-[var(--app-primary-foreground)] transition hover:brightness-95 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                                    >
