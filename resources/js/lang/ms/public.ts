export const landingMalayOverrides: Record<string, string> = {
    ...
    'Scan barangnya. Sisanya langsung tercatat.': 'Imbas barang. Selebihnya terus direkodkan.',
    ...
    'Dari transaksi ke stok, kas, dan laporan.': 'Daripada transaksi kepada stok, tunai dan laporan.',
    ...
    'Toko sibuk tidak butuh aplikasi yang ikut merepotkan.': 'Kedai yang sibuk tidak memerlukan aplikasi yang menyusahkan.',
    ...
    'Jualannya jalan. Catatannya tertinggal.': 'Jualan berjalan. Rekod pula tertinggal.',
    ...
    'Transaksi tersimpan di banyak tempat dan sulit diperiksa kembali.': 'Transaksi disimpan di banyak tempat dan sukar disemak semula.',
    'Stok baru dihitung saat terlambat': 'Stok hanya dikira apabila sudah terlambat',
    'Barang laris habis tanpa tanda, barang lambat justru terus menumpuk.':
        'Barang yang mendapat sambutan habis tanpa amaran, manakala barang kurang laris terus bertimbun.',
    'Rekap menghabiskan waktu': 'Penyediaan ringkasan mengambil masa',
    ...
    'Tiga gerakan. Satu catatan yang utuh.': 'Tiga langkah. Satu rekod yang lengkap.',
    'Barang masuk, transaksi selesai, kondisi toko langsung terbaca.':
        'Stok diterima, transaksi selesai dan keadaan kedai terus dapat dilihat.',
    'Scan atau cari barang': 'Imbas atau cari barang',
    'Gunakan barcode, nama produk, atau SKU.': 'Gunakan kod bar, nama produk atau SKU.',
    'Atur jumlah, pembayaran, dan kembalian.': 'Tetapkan kuantiti, pembayaran dan baki.',
    'Pantau hasilnya': 'Lihat hasilnya',
    'Stok, kas, dan laporan ikut diperbarui.': 'Stok, tunai dan laporan turut dikemas kini.',
    'Satu sistem toko': 'Satu sistem kedai',
    'Bukan cuma kasir. Semua pekerjaan penting ikut rapi.': 'Bukan sekadar juruwang. Semua kerja penting turut teratur.',
    'Kasir yang langsung paham barang': 'Juruwang terus mengenal pasti produk',
    ...
    'Uang toko tetap terbaca': 'Aliran wang kedai mudah dipantau',
    ...
    'Keputusan tidak lagi pakai tebakan': 'Keputusan tidak lagi berdasarkan tekaan',
    ...
    'Dari meja kasir sampai keputusan pemilik.': 'Daripada kaunter juruwang hingga keputusan pemilik.',
    ...
    'Naik 12% dari kemarin': 'Meningkat 12% berbanding semalam',
    'Operasional menyeluruh': 'Pengurusan menyeluruh',
    'Satu toko, banyak pekerjaan. Tetap satu alur.': 'Satu kedai, pelbagai urusan. Semuanya dalam satu aliran.',
    'Lihat paket yang tersedia': 'Lihat pelan yang ditawarkan',
    ...
    'Lebih sedikit mencatat ulang. Lebih banyak waktu untuk melayani.': 'Kurangkan rekod berulang. Lebihkan masa untuk melayan pelanggan.',
    Pekerjaan: 'Kerja',
    ...
    'Terhubung dengan operasional': 'Disepadukan dengan operasi',
    'Terpisah dari catatan penjualan': 'Berasingan daripada rekod jualan',
    'Baca laporan': 'Lihat laporan',
    'Ringkasan siap dilihat': 'Ringkasan sedia untuk dilihat',
    'Rekap kembali di akhir periode': 'Sediakan semula ringkasan pada akhir tempoh',
    'Pertanyaan umum': 'Soalan lazim',
    'Sebelum mulai, pastikan semuanya jelas.': 'Sebelum bermula, pastikan semuanya jelas.',
    'Apakah harus membeli alat scanner khusus?': 'Adakah perlu membeli pengimbas khas?',
    'Tidak. Barcode dapat dimasukkan dari perangkat yang Anda gunakan. Scanner eksternal tetap dapat dipakai untuk alur kasir yang lebih cepat.':
        'Tidak. Anda boleh menggunakan kamera pada peranti semasa. Pengimbas luaran juga boleh digunakan untuk urusan jualan yang lebih pantas.',
    'Apakah produk tanpa barcode tetap bisa dijual?': 'Bolehkah produk tanpa kod bar dijual?',
    ...
    'Apakah satu akun bisa mengelola beberapa toko?': 'Bolehkah satu akaun mengurus beberapa kedai?',
    ...
    'Apa yang berubah setelah transaksi disimpan?': 'Apakah yang berubah selepas transaksi disimpan?',
