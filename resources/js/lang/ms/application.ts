...
export const malayOverrides: Record<string, string> = {
    ...
    'Nonaktifkan produk': 'Nyahaktifkan produk',
    ...
    'Tinggalkan halaman?': 'Tinggalkan halaman ini?',
    'Perubahan produk yang belum disimpan akan hilang.': 'Perubahan produk yang belum disimpan akan hilang.',
    'Pilih tindakan untuk melanjutkan.': 'Pilih tindakan untuk meneruskan.',
    'Aksi cepat': 'Tindakan pantas',
    'Cara input': 'Kaedah input',
    Manual: 'Manual',
    'Pilih cara input, lalu pekerjaan yang ingin dilakukan.': 'Pilih kaedah input, kemudian pilih tugasan.',
    'Operasional, keuangan, master data, dan pengaturan toko.': 'Operasi, kewangan, data induk dan tetapan kedai.',
    'Akun & toko': 'Akaun & kedai',
    Preferensi: 'Pilihan',
    'Pilih tampilan yang nyaman digunakan pada perangkat ini.': 'Pilih paparan yang selesa untuk peranti ini.',
    'Simpan kata sandi': 'Simpan kata laluan',
    'Ulangi kata sandi baru': 'Ulang kata laluan baharu',
};
