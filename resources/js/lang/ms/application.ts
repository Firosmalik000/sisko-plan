...
export const malayOverrides: Record<string, string> = {
    ...
    'Mungkin produk yang sama atau varian dari': 'Mungkin produk yang sama atau varian daripada',
    'Produk sama, hapus duplikat': 'Produk sama, buang salinan pendua',
    'Gabungkan sebagai varian': 'Gabungkan sebagai varian',
    Harian: 'Harian',
    Bulanan: 'Bulanan',
    '3 Bulan': '3 bulan',
    '6 Bulan': '6 bulan',
    ...
    'Uang Masuk': 'Wang diterima',
    transaksi: 'transaksi',
    produk: 'produk',
    'Laporan lengkap': 'Lihat laporan',
    'Penjualan per Kategori': 'Jualan mengikut kategori',
    'Komposisi Kategori': 'Pecahan kategori',
    item: 'item',
    'Produk Terlaris': 'Produk terlaris',
    terjual: 'terjual',
    laba: 'untung',
    'Stok Kritis': 'Stok rendah',
    'Min.': 'Min.',
    'Kelola stok': 'Urus inventori',
    Penjualan: 'Jualan',
    'Toko Aktif': 'Kedai aktif',
    'Transaksi baru': 'Transaksi baharu',
    Kasir: 'Kaunter bayaran',
    'Tambah produk': 'Tambah produk',
    'Sudah dibaca': 'Sudah dibaca',
    'Stok habis': 'Kehabisan stok',
    'Lihat inventori': 'Lihat inventori',
    'Pengaturan akun': 'Tetapan akaun',
    'Kembali ke kasir': 'Kembali ke kaunter bayaran',
    'Kembali ke invoice': 'Kembali ke invois',
    'Kembali ke stok opname': 'Kembali ke kiraan stok',
    'Kembali ke beranda': 'Kembali ke papan pemuka',
    'Tambah kapasitas': 'Tambah kapasiti',
    'Pilih ruang kerja': 'Pilih ruang kerja',
    'Tambah toko baru': 'Tambah kedai',
    'Tambah kapasitas toko': 'Tambah kapasiti kedai',
    'Kasir cepat': 'Tindakan pantas',
    'Pilih mode dan aksi kasir': 'Pilih kaedah input dan tindakan',
    'Scan produk': 'Imbas produk',
    'Tanpa scan': 'Masukkan secara manual',
    'Barcode / QR': 'Kod bar / QR',
    Kamera: 'Kamera',
    Galeri: 'Galeri',
    Kelola: 'Urus',
    Satuan: 'Unit',
    'Nama kategori': 'Nama kategori',
    'Nama satuan': 'Nama unit',
    Singkatan: 'Singkatan',
    Ecer: 'Runcit',
    Besar: 'Pukal',
    Tambah: 'Tambah',
    ...
    Aktifkan: 'Aktifkan',
    'Isi manual': 'Masukkan secara manual',
    'Tambah kapasitas produk': 'Tambah kapasiti produk',
    Aktif: 'Aktif',
    'Tanpa kategori': 'Tanpa kategori',
    Kritis: 'Stok rendah',
    varian: 'varian',
    Edit: 'Sunting',
    'produk dalam antrean': 'draf produk',
    Menganalisis: 'Sedang menganalisis',
    dari: 'daripada',
    foto: 'foto',
    'Tambah produk lain': 'Tambah produk lain',
    'Mencari data…': 'Mencari maklumat produk…',
    'Perlu diisi manual': 'Masukkan maklumat secara manual',
    'Menunggu giliran': 'Dalam giliran',
    'Membaca foto produk…': 'Menganalisis foto produk…',
    'Coba lagi': 'Cuba lagi',
    ...
    'Pratinjau produk': 'Pratonton produk',
    'Pilih foto': 'Pilih foto',
    'Ambil foto dengan kamera': 'Ambil foto',
    'Hapus foto': 'Buang foto',
    ...
    'Varian ukuran / jenis': 'Varian saiz atau jenis',
    'Tidak aktif': 'Tidak aktif',
    'Estimasi HPP': 'Anggaran kos seunit',
    'HPP per 1 ecer': 'Kos seunit runcit',
    'Rekomendasi harga jual': 'Cadangan harga jualan',
    'Harga jual per 1 ecer': 'Harga seunit runcit',
    'Stok saat ini': 'Stok semasa',
    'Ingatkan saat stok tinggal': 'Ambang stok rendah',
    'Beda rasa / jenis': 'Rasa atau jenis berbeza',
    'Beda satuan / grosir': 'Saiz pek berbeza',
    'Stok gabungan': 'Stok bersama',
    Varian: 'Varian',
    'Nama varian': 'Nama varian',
    'SKU varian': 'SKU varian',
    'Foto varian': 'Foto varian',
    'HPP varian': 'Kos seunit varian',
    'Harga jual varian': 'Harga jualan varian',
    'Isi per kemasan': 'Unit setiap pek',
    'Tambah varian': 'Tambah varian',
    'Stok gabungan saat ini': 'Stok bersama semasa',
    'Produk aktif': 'Produk aktif',
    'Menyimpan...': 'Menyimpan…',
    'Simpan & lanjut': 'Simpan dan teruskan',
    'Produk yang sudah dipakai dalam transaksi atau stok tidak bisa dihapus.':
        'Produk yang digunakan dalam transaksi atau inventori tidak boleh dipadam.',
    'Product ini masih bisa dipakai sebagai riwayat, tetapi tidak akan muncul untuk transaksi baru.':
        'Produk ini kekal dalam rekod lama tetapi tidak boleh digunakan untuk transaksi baharu.',
    'Menonaktifkan...': 'Menyahaktifkan…',
    'Nonaktifkan product': 'Nyahaktifkan produk',
    'Menghapus...': 'Memadam…',
    'Foto produk baru': 'Foto produk baharu',
    'Master Data': 'Katalog',
    'Kamera pemindai barcode': 'Kamera pengimbas kod bar',
    'Matikan lampu': 'Matikan lampu',
    'Nyalakan lampu': 'Hidupkan lampu',
    'Arahkan kode ke dalam bingkai': 'Letakkan satu kod dalam bingkai',
    'Membaca kode...': 'Membaca kod…',
    'Arahkan ke barcode': 'Halakan ke kod bar',
    'Cari manual': 'Cari secara manual',
    Barcode: 'Kod bar',
    'Tambah kuota scan': 'Tambah kuota imbasan',
    'Mode barcode aktif. Arahkan kode ke kamera.': 'Mod kod bar. Halakan kamera ke kod.',
    'Barcode terbaca, mencari produk…': 'Kod dibaca. Mencari produk…',
    'Barcode terbaca otomatis tanpa menekan tombol': 'Kod bar dibaca secara automatik tanpa menekan butang',
    'Mencari barcode…': 'Mencari kod bar…',
    'Berhasil. Barcode ditemukan.': 'Kod bar berjaya ditemui.',
    'Pilih foto barcode': 'Pilih gambar kod bar',
    'Membaca foto…': 'Membaca gambar…',
    'Foto otomatis setelah kamera stabil': 'Gambar akan diambil secara automatik apabila kamera stabil',
    'Posisikan barang lalu tahan stabil': 'Letakkan produk kemudian pegang dengan stabil',
    'Tahan stabil…': 'Pegang dengan stabil…',
    'Foto berhasil diambil': 'Gambar berjaya diambil',
    'Mengenali produk…': 'Mengenal pasti produk…',
    Hasil: 'Hasil',
    'Produk belum terdaftar': 'Produk belum didaftarkan',
    'Berhasil. Produk masuk ke hasil scan.': 'Produk ditambah ke hasil imbasan.',
    'Kode terbaca, tetapi produk belum ada di katalog.': 'Kod dibaca tetapi tiada produk sepadan.',
    'Hasil (': 'Hasil (',
    'sedang dikenali': 'sedang dikenal pasti',
    'produk berhasil dikenali': 'produk dikenal pasti',
    'gagal dikenali': 'tidak dikenal pasti',
    'menunggu diproses': 'menunggu diproses',
    'Server sibuk, menunggu giliran…': 'Perkhidmatan sibuk. Menunggu giliran…',
    'Mencari produk…': 'Mencari produk…',
    'sedang dicocokkan dengan katalog.': 'sedang dipadankan dengan katalog.',
    'Foto belum berhasil diproses': 'Foto tidak dapat diproses',
    'Produk dilewati': 'Produk dilangkau',
    'Pilih produk': 'Pilih produk',
    'Batalkan lewati': 'Sertakan produk',
    'Estimasi total beli': 'Anggaran jumlah pembelian',
    'Menunggu hasil…': 'Menunggu hasil…',
    Selesai: 'Selesai',
    '/ unit': '/ unit',
    'Pilih ukuran/satuan': 'Pilih varian atau unit',
    'Ubah ukuran/satuan': 'Tukar varian atau unit',
    Jumlah: 'Kuantiti',
    'Subtotal beli': 'Subjumlah pembelian',
    'Ganti produk': 'Tukar produk',
    'Lewati produk ini': 'Langkau produk',
    'Paling cocok': 'Padanan terbaik',
    Dilewati: 'Dilangkau',
    'Perlu dipilih': 'Perlu dipilih',
    'Kembali ke hasil scan': 'Kembali ke hasil imbasan',
    'Pilih untuk foto ini': 'Gunakan untuk foto ini',
    'Cari nama produk': 'Cari nama produk',
    'Coba kata pencarian lain.': 'Cuba kata carian lain.',
    'Memproses foto…': 'Memproses gambar…',
    'Foto tidak dapat diproses. Pilih JPG, PNG, atau WebP di bawah 20 MB.':
        'Foto tidak dapat diproses. Pilih JPG, PNG atau WebP di bawah 20 MB.',
    'Membuka kamera…': 'Membuka kamera…',
    'Perubahan belum disimpan. Tinggalkan halaman ini?': 'Perubahan belum disimpan. Tinggalkan halaman ini?',
    'Kode ini digunakan lebih dari sekali pada produk yang sama.': 'Kod ini digunakan lebih daripada sekali dalam produk ini.',
    'Pilih satuan dari kelompok ecer.': 'Pilih unit runcit.',
    'Pilih satuan dari kelompok besar.': 'Pilih unit pukal.',
    'Analisis untuk pasar toko ini belum tersedia. Isi data produk secara manual.':
        'Analisis belum tersedia untuk pasaran kedai ini. Masukkan maklumat produk secara manual.',
    'Ada beberapa kode. Foto satu barcode saja.': 'Beberapa kod ditemui. Ambil gambar satu kod bar sahaja.',
