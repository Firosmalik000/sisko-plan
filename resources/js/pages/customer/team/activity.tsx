            ...
            <section aria-labelledby="activity-heading">
                <div className="mb-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {t('Register accountability and sales activity for accessible stores.')}
                    </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    {activity.length === 0 && (
                        <p className="rounded-xl border border-dashed p-6 text-sm text-muted-foreground sm:col-span-2">
                            {t('Staff activity will appear after the first sale or register shift.')}
                        </p>
                    )}
                </div>
            </section>
