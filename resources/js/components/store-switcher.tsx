                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        {canCreateStore ? (
                            ...
                            <SidebarMenuButton size="lg" onClick={() => setLimitOpen(true)}>
                                <span className="flex size-8 items-center justify-center rounded-lg bg-emerald-700 text-white">
                                    <LockKeyhole className="size-4" />
                                </span>
                                <span className="grid flex-1 text-left text-sm">
                                    <span className="font-semibold">Tambah kapasitas toko</span>
                                    <span className="text-xs text-muted-foreground">Hubungi admin</span>
                                </span>
                            </SidebarMenuButton>
                        )}
                    </SidebarMenuItem>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-64" align="start" side="bottom">
                            ...
                            {canCreateStore ? (
                                ...
                                <DropdownMenuItem className="gap-2" onSelect={() => setLimitOpen(true)}>
                                    <LockKeyhole className="size-4" />
