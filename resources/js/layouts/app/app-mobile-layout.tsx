                ...
                {canCreateStore ? (
                    ...
                    >
                        ...
                        <span className="min-w-0">
                            ...
                            <span className="block truncate text-xs text-[var(--muted-foreground)]">Mulai operasional</span>
                        </span>
                    </Link>
                ) : (
                    <button
                        ...
                        className="flex min-w-0 items-center gap-2 rounded-2xl bg-white px-3 py-2 text-left shadow-sm ring-1 ring-[var(--app-ink)]/8"
                    >
                        <span className="flex size-8 shrink-0 items-center justify-center rounded-xl bg-[#f5b942] text-[var(--app-ink)]">
