...
test('scanner limit actions open the contact dialog without linking to pricing', () => {
    const cameraViewport = source('../../resources/js/features/product-scanner/CameraViewport.tsx');
    const scanReview = source('../../resources/js/features/product-scanner/ScanReview.tsx');
