...
return [
    ...
    'array_keys' => 'វាល :attribute ត្រូវតែមានកូនសោខាងក្រោមតែប៉ុណ្ណោះ៖ :values ។',
    'ascii' => 'វាល :attribute ត្រូវតែមានតួអក្សរ និងនិមិត្តសញ្ញាលេខមួយបៃប៉ុណ្ណោះ។',
    'base64' => 'វាល :attribute ត្រូវតែជាខ្សែអក្សរ Base64 ត្រឹមត្រូវ។',
    ...
    'decimal' => 'វាល :attribute ត្រូវតែមានខ្ទង់ទសភាគ :decimal ។',
    ...
    'digits' => 'វាល :attribute ត្រូវតែជាលេខ :digits ។',
    'digits_between' => 'វាល :attribute ត្រូវតែស្ថិតនៅចន្លោះលេខ :min និង :max ។',
    'dimensions' => 'វាល :attribute មានវិមាត្ររូបភាពមិនត្រឹមត្រូវ។',
    'distinct' => 'វាល :attribute មានតម្លៃស្ទួន។',
    'doesnt_contain' => 'វាល :attribute មិនត្រូវមានណាមួយខាងក្រោម៖ :values ។',
    ...
    'extensions' => 'វាល :attribute ត្រូវតែមានផ្នែកបន្ថែមមួយដូចខាងក្រោម៖ :values ។',
    ...
    'gt' => [
        ...
        'string' => 'វាល :attribute ត្រូវតែធំជាងតួអក្សរ :value ។',
    ],
    'gte' => [
        ...
        'string' => 'វាល :attribute ត្រូវតែធំជាង ឬស្មើតួអក្សរ :value ។',
    ],
    ...
    'in_array_keys' => 'វាល :attribute ត្រូវ​តែ​មាន​យ៉ាង​ហោច​ណាស់​មួយ​ក្នុង​ចំណោម​សោ​ដូច​ខាង​ក្រោម៖ :values ។',
    ...
    'lt' => [
        'array' => 'វាល :attribute ត្រូវតែមានធាតុ :value តិចជាង។',
        'file' => 'វាល :attribute ត្រូវតែតិចជាង :value គីឡូបៃ។',
        'numeric' => 'វាល :attribute ត្រូវតែតិចជាង :value ។',
        'string' => 'វាល :attribute ត្រូវតែតិចជាងតួអក្សរ :value ។',
    ],
    'lte' => [
        'array' => 'វាល :attribute មិនត្រូវមានធាតុច្រើនជាង :value ទេ។',
        'file' => 'វាល :attribute ត្រូវតែតិចជាង ឬស្មើ :value គីឡូបៃ។',
        'numeric' => 'វាល :attribute ត្រូវតែតិចជាង ឬស្មើ :value ។',
        'string' => 'វាល :attribute ត្រូវតែតិចជាង ឬស្មើនឹងតួអក្សរ :value ។',
    ],
    'mac_address' => 'វាល :attribute ត្រូវតែជាអាសយដ្ឋាន MAC ត្រឹមត្រូវ។',
    'max' => [
        'array' => 'វាល :attribute មិនត្រូវមានធាតុច្រើនជាង :max ទេ។',
        'file' => 'វាល :attribute មិនត្រូវធំជាង :max គីឡូបៃទេ។',
        'numeric' => 'វាល :attribute មិនត្រូវធំជាង :max ទេ។',
        'string' => 'វាល :attribute មិនត្រូវធំជាងតួអក្សរ :max ទេ។',
    ],
    'max_digits' => 'វាល :attribute មិនត្រូវមានច្រើនជាងលេខ :max ទេ។',
    'mimes' => 'វាល :attribute ត្រូវតែជាឯកសារប្រភេទ៖ :values ។',
    'mimetypes' => 'វាល :attribute ត្រូវតែជាឯកសារប្រភេទ៖ :values ។',
    'min' => [
        'array' => 'វាល :attribute ត្រូវតែមានធាតុ :min យ៉ាងតិច។',
        'file' => 'វាល :attribute ត្រូវតែមានយ៉ាងហោចណាស់ :min គីឡូបៃ។',
        'numeric' => 'វាល :attribute ត្រូវតែមានយ៉ាងហោចណាស់ :min ។',
        'string' => 'វាល :attribute ត្រូវតែមានយ៉ាងហោចណាស់តួអក្សរ :min ។',
    ],
    'min_digits' => 'វាល :attribute ត្រូវតែមានយ៉ាងហោចណាស់លេខ :min ។',
    ...
    'size' => [
        ...
        'numeric' => 'វាល :attribute ត្រូវតែ :size ។',
        'string' => 'វាល :attribute ត្រូវតែជាតួអក្សរ :size ។',
    ],
    'starts_with' => 'វាល :attribute ត្រូវតែចាប់ផ្តើមជាមួយមួយក្នុងចំណោមខាងក្រោម៖ :values ។',
