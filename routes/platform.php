...
Route::prefix('super-admin')->name('super-admin.')->group(function () {
    ...
    Route::middleware(['auth', 'platform-admin', 'throttle:platform-writes'])->group(function () {
        ...
        Route::middleware('platform-admin.2fa')->group(function () {
            ...
            Route::get('promotions', [PromotionController::class, 'index'])->middleware('can:'.PlatformPermission::PROMOTIONS_VIEW)->name('promotions.index');
            Route::post('promotions', [PromotionController::class, 'store'])->middleware('can:'.PlatformPermission::PROMOTIONS_MANAGE)->name('promotions.store');
            Route::patch('promotions/{promotion}', [PromotionController::class, 'update'])->middleware('can:'.PlatformPermission::PROMOTIONS_MANAGE)->name('promotions.update');
            Route::patch('promotions/{promotion}/status', [PromotionController::class, 'updateStatus'])->middleware('can:'.PlatformPermission::PROMOTIONS_MANAGE)->name('promotions.status');
            Route::delete('promotions/{promotion}', [PromotionController::class, 'destroy'])->middleware('can:'.PlatformPermission::PROMOTIONS_MANAGE)->name('promotions.destroy');
